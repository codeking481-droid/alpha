        ...
        <div className="space-y-6">
          ...
          {community && (
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-4"><div className="text-[11px] tracking-widest uppercase font-bold text-white/30">WhatsApp (Main Group)</div><div className="text-lg font-black text-white mt-1">{community.community?.whatsapp?.groups?.find(g=>g.name.includes('Main'))?.members || 130} members</div><div className="text-xs text-white/30">10 posts</div></div>
              <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-4"><div className="text-[11px] tracking-widest uppercase font-bold text-white/30">WhatsApp (Cyber Security)</div><div className="text-lg font-black text-white mt-1">{community.community?.whatsapp?.groups?.find(g=>g.name.includes('Cyber'))?.members || 85} members</div><div className="text-xs text-white/30">10 posts</div></div>
              <div className="rounded-2xl bg-white/[0.04] border border-white/10 p-4"><div className="text-[11px] tracking-widest uppercase font-bold text-white/30">Telegram + YouTube</div><div className="text-lg font-black text-white mt-1">{community.community?.telegram?.members} TG • {community.community?.youtube?.subscribers}+ YT</div><div className="text-xs text-white/30">10 TG posts • 2 videos</div></div>
            </div>
          )}
