...
const clients = [
  { id: 1, name: "Adebayo Oke", company: "Paystack Alumni Co", status: "Active", totalBilled: "$42k", mrr: "$6k", lastInvoice: "INV-2026-1042 â€¢ Aug 15" },
  { id: 2, name: "Sarah Chen", company: "Dominion Labs", status: "Active", totalBilled: "$68k", mrr: "$8.5k", lastInvoice: "INV-2026-1041 â€¢ Aug 10" },
  { id: 3, name: "Chidi Nwosu", company: "Genesis Media", status: "Active", totalBilled: "$36k", mrr: "$4.2k", lastInvoice: "INV-2026-1039 â€¢ Jul 30" },
  { id: 4, name: "Emily Roth", company: "Venture Builders", status: "At Risk", totalBilled: "$18k", mrr: "$3.8k", lastInvoice: "INV-2026-1043 â€¢ Aug 20" },
  { id: 5, name: "Tunde Balogun", company: "AlphaTek Partners", status: "Paused", totalBilled: "$12k", mrr: "$0", lastInvoice: "INV-2026-1035 â€¢ Jun 12" },
]
    ...
    <div className="min-h-screen bg-[#0B0215] text-white selection:bg-[#FFD700] selection:text-[#0B0215]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 flex flex-wrap items-center justify-between gap-4 animate-fadeIn">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#FFD700] to-[#F59E0B] flex items-center justify-center text-[#0B0215] font-black shadow-gold text-lg">ðŸ’°</div>
          <div>
            ...
            <p className="text-xs text-white/50 tracking-widest uppercase font-semibold">The Money Engine â€¢ Premium Beyond Imagination</p>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 pb-10 space-y-6">
        {/* Revenue KPIs â€” premium numbers 5xl */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="gold-card p-8 rounded-2xl animate-slideUp">
            ...
            <div className="text-xs text-emerald-400 font-bold mt-2">â†— +12.4% vs last quarter</div>
          ...
          <div className="glass p-8 rounded-2xl animate-slideUp" style={{ animationDelay: "0.05s" }}>
            ...
            <div className="text-xs text-emerald-400 font-bold mt-2">â†— +8.2% MoM</div>
          ...
          <div className="glass p-8 rounded-2xl animate-slideUp" style={{ animationDelay: "0.1s" }}>
            ...
            <div className="text-xs text-emerald-400 font-bold mt-2">â†˜ -0.4% vs last month</div>
          ...
          <div className="glass p-8 rounded-2xl animate-slideUp" style={{ animationDelay: "0.15s" }}>
            ...
            <div className="text-xs text-white/30 font-bold mt-2">Median â€¢ 12 deals</div>
        ...
        <div className="glass rounded-2xl p-4 flex flex-wrap items-center justify-between gap-4 animate-fadeIn">
          ...
          <div className="text-xs text-white/30">Updated 5 min ago â€¢ D1 live</div>
        </div>
          ...
          <div className="space-y-6">
            {selected && (
              <div className="gold-card rounded-2xl p-6 animate-fadeIn border border-[#FFD700]/20">
                <div className="text-sm font-bold text-[#FFD700]">{selected.name} â€” {selected.company}</div>
                <div className="text-xs text-white/60 mt-1">Status: {selected.status} â€¢ Billed: {selected.totalBilled} â€¢ MRR: {selected.mrr}</div>
        ...
        <div className="glass rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 animate-fadeIn">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center text-white">âœ“</div>
            <div><div className="text-sm font-bold text-white">Money engine â€” live</div><div className="text-xs text-white/40">Invoices via email â€¢ Contracts eSigned â€¢ Revenue synced</div></div>
          </div>
          <div className="flex gap-2">
      ...
      <footer className="text-center py-10 text-xs text-white/20 tracking-widest uppercase font-semibold">
        Deal Desk â€¢ Where money comes in â€¢ $10K/month agency experience ðŸ‡³ðŸ‡¬ðŸ”¥ðŸš€
      </footer>
    </div>
  )
}
